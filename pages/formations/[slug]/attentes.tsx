...
function Attente({ index }: any) {
  ...
  const mutation = useMutation({
    mutationFn: (message: any) => patchData(
      `/api/backoffice/Session/${nextSession.Session_id.id}`, 
                ...
                <form onSubmit={handleFormSubmit(onSubmit)}>
                  <div className="md:text-lg">
                    <div className="text-left mb-3 font-extralight">
                      ...
                      <p>Nous voulons que cette formation vous soit bénéfique.</p>
                      <p>En quelques mots quelles sont vos attentes pour cette formation</p>
                    </div>
                    <div className="mb-4">
