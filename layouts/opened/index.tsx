  ...
  return (
    <section className="bg-gradient-to-r to-slate-100 via-purple-50 from-blue-100 flex flex-col justify-between min-h-screen">
      <Head>
        ...
        <meta name="description" content="Société de conseil en nouvelles technologies centrée sur l'expérience client." />
        <meta property="og:title" content="chillo services" />
        <meta property="og:type" content="website" />
        <meta property="og:description" content="Société de conseil en nouvelles technologies centrée sur l'expérience client." />
