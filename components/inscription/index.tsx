  ...
  return (    
    ...
    {(() => {
        switch(section) {
            case "SAVING":
              return (
                <div className="saving flex flex-col items-center justify-center h-full">
                  <h2 className="font-extralight text-center text-2xl w-full">Un instant nous enregistrons vos informations</h2>
                </div>
              )
            case "SAVED":
                return (
                  <div className="saved flex flex-col items-center justify-center h-full">
                    <p className='font-extralight text-2xl text-center  py-3 text-green-700'>
                      Merci<br /> 
                ...
                <form onSubmit={handleFormSubmit(onSubmit)} className="h-full">
                  <div className="text-lg flex flex-col justify-between h-full">  
                    ...
                    <div className="mb-1 text-lg">
                        <label htmlFor="phone" className="font-extralight form-label mb-1 flex justify-between">
                          Téléphone
                        </label>
