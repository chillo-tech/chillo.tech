      ...
      <div className="px-3 py-4">
        <p className="grid grid-cols-2 mt-1 text-sm text-gray-400">
          <span className="text-left flex items-center justify-start">
            <FaRegChartBar />
            {data.nivbeau === 'BEGINER' && <span className="mx-1">Débutant</span>}
            {data.nivbeau === 'INTERMEDIATE' && <span className="mx-1">Intermediaire</span>}
            {data.nivbeau === 'CONFIRMED' && <span className="mx-1">Confirmé</span>}
          </span>
